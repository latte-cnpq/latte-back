...
public class ArticleCustomRepositoryImpl implements ArticleCustomRepository {
    ...
    @Override
    public Page<Article> AdvancedSearch(String title, LocalDate startDate, LocalDate endDate, UUID researcherId, UUID instituteId, Pageable pageable) {
    ...
    @Override
    public Page<Article> AdvancedSearch(String title, LocalDate startDate, LocalDate endDate, UUID researcherId, Pageable pageable) {
