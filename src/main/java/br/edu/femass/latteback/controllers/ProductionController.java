...
public class ProductionController {
   ...
   public ResponseEntity<Object> getAll() {
    ...
    public CollectionProduction AdvancedSearch(
            @RequestParam(value = "title", required = false) String title,
            @RequestParam(value = "researcherId", required = false) UUID researcherId,
            @RequestParam(value = "instituteId", required = false) UUID instituteId,
            @RequestParam(value = "startDate", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @RequestParam(value = "endDate", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate,
            @RequestParam(value = "type", required = false) ProductionType type) {

        return productionService.AdvancedSearch(title, researcherId, instituteId, startDate, endDate, type);
    }
